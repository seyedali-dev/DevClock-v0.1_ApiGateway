...
class KeycloakSecurityUtilTest {
    ...
    private @InjectMocks KeycloakSecurityUtil keycloakSecurityUtil;
    ...
    void extractEmail() {
        ...
        // when
        String extractedEmail = this.keycloakSecurityUtil.extractEmail(jwt);

        // then
        assertThat(extractedEmail)
                .as("Must not be empty")
                .isNotNull()
                .as("Must be same: test@gmail.com")
                .isEqualTo(email);
    }
